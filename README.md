...
- **[docs/producao.md](docs/producao.md)** — deploy: imagens publicadas no GHCR (a VPS só puxa), passo a passo (VPS + Caddy), variáveis de ambiente e checklist de go-live
